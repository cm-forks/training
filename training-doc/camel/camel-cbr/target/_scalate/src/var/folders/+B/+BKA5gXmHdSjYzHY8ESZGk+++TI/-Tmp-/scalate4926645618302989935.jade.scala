...
object $_scalate_$scalate4926645618302989935_jade {
...
class $_scalate_$scalate4926645618302989935_jade extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$scalate4926645618302989935_jade.$_scalate_$render(context)
}
