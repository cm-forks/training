...
object $_scalate_$scalate3117243139403817204_jade {
...
class $_scalate_$scalate3117243139403817204_jade extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$scalate3117243139403817204_jade.$_scalate_$render(context)
}
