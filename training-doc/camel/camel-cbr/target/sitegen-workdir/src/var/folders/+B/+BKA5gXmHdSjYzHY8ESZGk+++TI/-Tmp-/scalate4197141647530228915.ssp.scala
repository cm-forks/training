...
object $_scalate_$scalate4197141647530228915_ssp {
...
class $_scalate_$scalate4197141647530228915_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$scalate4197141647530228915_ssp.$_scalate_$render(context)
}
