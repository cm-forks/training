...
object $_scalate_$scalate8028708466748937035_ssp {
...
class $_scalate_$scalate8028708466748937035_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$scalate8028708466748937035_ssp.$_scalate_$render(context)
}
