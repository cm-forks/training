...
object $_scalate_$scalate7314057108641952297_ssp {
...
class $_scalate_$scalate7314057108641952297_ssp extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$scalate7314057108641952297_ssp.$_scalate_$render(context)
}
